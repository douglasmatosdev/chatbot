...
const LANG_PT_BR = {
	...
	dev_details: "Desenvolvedor web",
	dev_desc: "Focado em tecnologias disruptivas e tecnologias que possam agragar valor desde de uma empresa como uma sociedade, tais quais: Machine Learning, soluções Linux, Desenvolvimento JavaScript(ECMAScript6), NodeJS, SQL,  HTML5, CSS3, jQuery, ReactJS e muito mais.",
	dev_email_contact: "douglasmatosdev@gmail.com",
	...
	hello_user_name_first_time_title: "Olá, eu sou botPadawan",
	...
	youremail_placeholder: "Digite seu e-mail",
	...
	budget1: "Enviamos uma demonstração para o e-mail"
};
...
module.exports = {
	...
	fShowMyCurriculum: function() {
		const my_dev="chatbot-server/images/my_dev.png";
		...
		var myCurriculum = {
			...
			"actions": [
				...
				},
				{
					...
					"url": "mailto:douglasmatosdev@gmail.com"
				}
			]
		};
	...
	fShowDonationCards: function(coin_name) {
		...
		var donation_img_btc="chatbot-server/images/donation_btc.png";
		var donation_img_nano="chatbot-server/images/donation_nano.png";
		var donation_img_ltc="chatbot-server/images/donation_ltc.png";
		var donation_img_doge="chatbot-server/images/donation_doge.png";
		var img;
		var myCoinName;
		var myCoinAddress;
...
//					"poster": "https://adaptivecards.io/content/poster-video.png",
					"poster": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR6zkRx4sPbx0tG6p6nrcCFvfkWY4Y01LI1aJpd-NRRkdFedIW8mw&s",
					"sources": [
						{
							"mimeType": "video/mp4",
			...
			"body": [
			     ...
			     },
				{
					...
					"sources": [
						{
							"mimeType": "video/mp4",
							"url":"https://github.com/douglasmatosdev/botPadawan/blob/master/chatbot-server/images/einstein_cracks_joke.mp4?raw=true"
						}
					]
				}
    			],
	...
	learnMoreIntelieLive: function(intelieLivePresentation1) {
		var defaultLang=(USE_LANG===SERVER_LANG_ENG_US);
		var live="chatbot-server/images/intelie_images/live_logo_w.png";

		var imgLive = "data:image/png;base64," + Buffer.from(fs.readFileSync(live)).toString('base64');
			...
			"body": [
				{
					...
					"items": [
						...
						{
							"type": "TextBlock",
							"text": defaultLang?"A unique platform in the national market, capable of monitoring all types of operations in real time: from site visitors to deepwater oil exploration.":
							"Uma plataforma única no mercado nacional, capaz de monitorar todo tipo de operação em tempo real: de visitantes no site à exploração de petróleo em águas profundas.",
							"weight": "Bolder",
							"horizontalAlignment": "Center",
							"spacing": "Large",
							"separator": true,
		...
		return {content: intelieLiveCard};
	}
